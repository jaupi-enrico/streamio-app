...
class _SourceBadge extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final label = ref.watch(providerLabelProvider(provider));
              ...
              child: ClipRRect(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    // The rail spans every source, not just the one being
                    // browsed, so each card says where it came from.
                    Positioned(
                      top: 6,
                      left: 6,
                      right: 6,
                      child: _SourceBadge(provider: entry.provider),
                    ),
                    if (progress != null)
                      Positioned(
                        left: 0,
