...
/// `account.html` — the same eight tabs (watchlist, favorites, history,
/// ratings, stats, social, preferences, profile). Admin isn't one of them: it
/// is an action in the app bar, shown only to accounts the server considers
/// admins.
...
class _AccountScreenState extends ConsumerState<AccountScreen>
  ...
  /// Order must match [TabBarView.children] below — both are positional.
  static const _tabs = <({String id, String label, IconData icon})>[
    ...
    (id: 'stats', label: 'Stats', icon: Icons.insights_outlined),
...
class _Hero extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final counts = ref.watch(followCountsProvider).value;
