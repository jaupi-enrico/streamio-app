...
class ClientOutdatedNotifier extends Notifier<ClientOutdatedException?> {
  @override
  ClientOutdatedException? build() {
    ...
    if (client != null) {
      final subscription = client.onClientOutdated.listen(report);
...
final clientOutdatedProvider =
    NotifierProvider<ClientOutdatedNotifier, ClientOutdatedException?>(
        ClientOutdatedNotifier.new);
