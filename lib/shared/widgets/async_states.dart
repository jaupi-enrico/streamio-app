...
class ErrorState extends StatelessWidget {
  ...
  static String messageFor(Object error) {
    // Riverpod 3 wraps what a provider threw when rethrowing it at a reader,
    // so the exception worth showing is one level down.
    if (error is ProviderException) return messageFor(error.exception);
