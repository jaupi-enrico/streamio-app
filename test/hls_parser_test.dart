...
/// The demuxed case is the important one: upstream serves video and audio as
...
void main() {
  const masterUrl =
      'https://media.example.net/playlist/12345?token=abc&expires=999';
  ...
  group('parseMaster', () {
    ...
    test('resolves relative URIs against the playlist, dropping its query', () {
      ...
      expect(
        ...
        'https://media.example.net/playlist/playlist/12345'
        '?type=video&rendition=480p&token=abc',
      );
